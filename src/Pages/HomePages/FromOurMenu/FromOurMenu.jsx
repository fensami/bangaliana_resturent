...
const FromOurMenu = () => {
  ...
  return (
    <>
      ...
      <Title title="From Our Menu"></Title>
      ...
      >
        {recipies.map((recipe, index) => (
          <SwiperSlide key={index}>
            <article
              className="card bg-cover bg-center md:w-96 relative text-white"
              style={{ backgroundImage: `url(${recipe.image})` }}
            >
              <div className="content-1 bg-gradient-to-t from-[#529661] to-[#248a69]">
                <h1 className="bg-yellow-200 w-24 rounded-e-sm text-black px-1 py-1 hover:hidden block font-bold ">
                  Top seller
                </h1>
                <h1 className="text-center text-xl font-bold pt-5">
                  {recipe.name}
                </h1>
