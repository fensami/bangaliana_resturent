      ...
      {specials.map((special, index) => (
        ...
        >
          <div className="background_b">
            <div className="py-4">
              <img
                className="rounded-full border-[6px] border-white animate-spin1 w-28 h-28 mx-auto"
                src={special.image}
                alt=""
              />
            </div>
            <div className="text-center">
              ...
              <button className="bg-white px-4 text-xl font-bold rounded-lg py-2 shadow-black text-black shadow-sm">
                Add To Cart
              </button>
            </div>
          </div>
