    ...
    <div className="banner ">
      <div className="text-xl  h-full w-full bg-opacity-20 text-white bg-black">
        <div className="">
          ...
          <p className="my-5 md:text-5xl text-center md:pl-5 px-3 md:px-0 font-semibold font-mono">
            Welcome to Bangaliana Resturent
          </p>
          <p className="text-center md:pl-5 px-3 md:px-0 md:text-4xl font-mono">
            Bengali Culinary House
          </p>

          <p className="text-center md:w-1/2 mx-auto font-sans">
