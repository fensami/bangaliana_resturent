      ...
      <div className="flex justify-between items-center py-2 md:py-3 md:px-10 px-7">
        <div className="flex items-center gap-3">
          <img
            ...
            src="https://play-lh.googleusercontent.com/rfB_azG4EK-K1Dpiw9jaJsEWPZAF905QZfNVDPEg5Ec_93VouIlnE5MsTdJUuv-p-q8j=s256-rw"
            alt=""
          />
        ...
        <div className="flex items-center gap-3">
          ...
          <img
            className="w-10 h-10 p-2 rounded-lg md:block hidden font-bold bg-white"
            src={icon}
            alt=""
          />
